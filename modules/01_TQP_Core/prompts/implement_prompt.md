...
# Module-Specific Instructions: 01_TQP_Core

## Responsibilities
Implement all global constructs:
- Base data types
- Enums
...
- spec.md: Defines required primitives and shared types.
- data_contract.md: Ensure all global schemas are implemented exactly.
- implementation_notes.md: Follow initialization rules and naming.

## Integration requirements
Every other module imports from TQP_Core.  
Ensure API stability and forward compatibility.

## Do NOT include:
- Any simulation logic
- Any stressor or intervention logic
- Any BDI logic
