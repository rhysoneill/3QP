...
# Module-Specific Instructions: 07_Stressor_Model

## Responsibilities
Implement stressor dynamics:
...
## Required behavior
Capture both acute and cumulative stress effects.
Integrate physiology and social-network pathways.

## Integration
Outputs feed directly into:
- 08_Intervention_Engine
- 06_BDI_Cycle (feedback)
