...
# Module-Specific Instructions: 04_SlowFast_Physiology

## Responsibilities
Implement bi-phasic physiology model:
- Slow baseline drifts
- Fast stress responses
- Physiological state transitions

## Algorithmic requirements
Follow all formulas, thresholds, and causal graphs described in theory_basis.md.
...
Implement logging hooks for all major state changes.
