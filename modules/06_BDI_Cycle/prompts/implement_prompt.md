...
# Module-Specific Instructions: 06_BDI_Cycle

## Responsibilities
Implement full BDI reasoning loop:
- Belief update
- Desire formation
...
## Inputs
- Physiology state (Module 04)
- Social context (Module 05)
- Stressor signals (Module 07)

## Requirements
Follow all cognitive process rules in theory_basis.md.
Implement deterministic and stochastic paths exactly as defined.
