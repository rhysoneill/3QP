...
# Module-Specific Instructions: 08_Intervention_Engine
...
## Requirements
Map interventions to stressor targets.
Compute effectiveness based on theory_basis.md.
Feed modified states back into BDI + physiology.

Ensure all interventions are logged with timestamps and causal links.
