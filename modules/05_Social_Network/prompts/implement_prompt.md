...
# Module-Specific Instructions: 05_Social_Network

## Responsibilities
Implement social relationship graph:
- Agent ties
- Influence channels
- Social buffering
- Relationship decay and repair
...
Ensure efficient lookup of neighbors, tie strengths, and influence flows.
Respect all constraints in theory_basis.md.
