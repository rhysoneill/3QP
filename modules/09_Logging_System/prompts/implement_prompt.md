...
# Module-Specific Instructions: 09_Logging_System
...
- State snapshots
- Telemetry capture
- Episode-level trace logs

## Requirements
Accept event inputs from all modules.
Write logs in structured formats defined in data_contract.md.
Support replay and validation needs.
