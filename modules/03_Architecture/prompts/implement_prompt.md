...
# Module-Specific Instructions: 03_Architecture

## Responsibilities
Implement the system orchestrator:
- Module registry
...
- Standardized hooks for all modules

## Integration requirements
All modules must plug into this architecture.  
Respect the dependencies laid out in spec.md.

## Do NOT include:
- Domain logic (BDI, stressors, physiology)
- Interventions
- Impact evaluation
